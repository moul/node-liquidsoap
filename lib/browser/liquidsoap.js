...
require.define("/tmp/client.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
...
require.define("/tmp/api.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  ...
  API.Private.IcecastWrapper = (function(_super) {

    __extends(IcecastWrapper, _super);

    IcecastWrapper.path = "/output/icecast";

    function IcecastWrapper(src, obj) {
      var _ref1;
      if (((_ref1 = obj.type) != null ? _ref1.opts : void 0) != null) {
        mixin(obj.type.opts, obj);
      }
      IcecastWrapper.__super__.constructor.call(this, src, obj);
    }

    return IcecastWrapper;

  })(API.Private.Stateful);

  API.Private.Encoder = (function() {
...
require.define("/tmp/api/sources.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var API,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
require.define("/tmp/api/operators.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var API,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
require.define("/tmp/api/outputs.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var API,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  API.Output.Icecast = function(opts) {
    ...
    if ((_ref = output.opts) == null) {
      output.opts = {};
    }
    output.opts.mount = opts['mount'];
    _ref1 = opts['encoder'].opts;
    for (key in _ref1) {
      value = _ref1[key];
...
require.define("/tmp/api/encoders.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var API;
...
require.define("/tmp/entry.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
